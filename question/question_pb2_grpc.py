...
import question.question_pb2 as question__pb2
...
class QuestionStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.get_question = channel.unary_stream(
...
def add_QuestionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'get_question': grpc.unary_stream_rpc_method_handler(
...
class Question(object):
    ...
    def get_question(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Question/get_question',
